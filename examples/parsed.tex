...
Let $f(x,t)$ and its partial derivative $$ be continuous in $x$ and $t$ in some region of the $(x,t)$ plane that includes $a(x)\leq t\leq b(x)$ and $x_0\leq x\leq x_1$. Suppose also that the functions $a(x)$ and $b(x)$ are continuous and have continuous derivatives for $x_0\leq x\leq x_1$. Then, for $x_0\leq x\leq x_1$, we have:
$$$$
