...
pub enum Node<'a> {
    ...
    Letter(char, Variant),
    Operator(char),
    Function(&'a str, Option<Vec<Node<'a>>>),
    Space(f32),
    Subscript(Vec<Node<'a>>, Vec<Node<'a>>),
    Superscript(Vec<Node<'a>>, Vec<Node<'a>>),
    SubSup {
        target: Vec<Node<'a>>,
        sub: Vec<Node<'a>>,
        sup: Vec<Node<'a>>,
    },
    OverOp(char, Accent, Vec<Node<'a>>),
    UnderOp(char, Accent, Vec<Node<'a>>),
    Overset {
        over: Vec<Node<'a>>,
        target: Vec<Node<'a>>,
    },
    ...
    Under(Vec<Node<'a>>, Vec<Node<'a>>),
    UnderOver {
        target: Vec<Node<'a>>,
        under: Vec<Node<'a>>,
        over: Vec<Node<'a>>,
    },
    Sqrt(Option<Vec<Node<'a>>>, Vec<Node<'a>>),
    Frac(Vec<Node<'a>>, Vec<Node<'a>>, LineThickness),
    Row(Vec<Node<'a>>),
    Fenced {
        open: char,
        close: char,
    ...
    Text(&'a str),
    Matrix(Vec<Node<'a>>, ColumnAlign),
    Ampersand,
    NewLine,
    Slashed(Vec<Node<'a>>),
    Style(Option<DisplayStyle>, Vec<Node<'a>>),
    Undefined(&'a str),
}
